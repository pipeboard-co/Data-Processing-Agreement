...
By using the Service, the Customer accepts this DPA. The canonical version is maintained as Markdown in the public repository [pipeboard-co/Data-Processing-Agreement](https://github.com/pipeboard-co/Data-Processing-Agreement); the same content is rendered at [pipeboard.co/dpa](https://pipeboard.co/dpa). A counter-signed PDF version is available on request from privacy@pipeboard.co.

**Subscribe to changes:** click "Watch" on the [public repository](https://github.com/pipeboard-co/Data-Processing-Agreement) (Releases or all activity) to receive a GitHub notification on every change, or point a page-monitoring tool of your choice (for example, Visualping, Distill, or Wachete) at this page.
...
The subject matter, duration, nature, and purpose of the Processing, the types of Customer Personal Data, and the categories of Data Subjects are described in [Annex I](#annex-i--description-of-processing).
...
The Customer authorizes Pipeboard to engage Sub-processors to Process Customer Personal Data, subject to the conditions set out in this Section 7 and in [Annex III](#annex-iii--sub-processors).
...
R 72, 223 Quadra C16 Lote 12/15 Sala 1507, Cond QS 01, Jd Goias,
Goiânia, GO, Brazil, CEP 74805-480
